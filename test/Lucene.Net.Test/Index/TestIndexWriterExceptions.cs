...
namespace Lucene.Net.Index
{
	...
	public class TestIndexWriterExceptions:LuceneTestCase
	{
        ...
        internal ThreadLocal<object> doFail = new ThreadLocal<object>(); 
		...
		public class MockIndexWriter:IndexWriter
		{
			...
			public MockIndexWriter(TestIndexWriterExceptions enclosingInstance, Directory dir, Analyzer a, bool create, MaxFieldLength mfl):base(dir, a, create, mfl, null)
			{
				InitBlock(enclosingInstance);
			}
