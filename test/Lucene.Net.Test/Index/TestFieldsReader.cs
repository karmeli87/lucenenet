    ...
    public class TestFieldsReader : LuceneTestCase
	{
		...
		public virtual void  TestLoadFirst()
		{
			...
			for (System.Collections.IEnumerator iter = l.GetEnumerator(); iter.MoveNext(); )
			{
				...
				Assert.IsTrue(field != null, "field is null and it shouldn't be");
				System.String sv = field.StringValue(null);
		...
		public class FaultyFSDirectory:Directory
		{
			...
			{
				return new FaultyIndexInput(fsDir.OpenInput(name, null));
			}
			public override System.String[] ListAll(IState state)
			{
				return ((Directory) fsDir).ListAll(null);
			}
		...
		private class FaultyIndexInput:BufferedIndexInput, ILuceneCloneable
		{
			...
			{
				return delegate_Renamed.Length(null);
			}
			...
			{
				return new FaultyIndexInput((IndexInput) delegate_Renamed.Clone(null));
			}
		}
